import"core-js/modules/es6.string.iterator";import"core-js/modules/es6.set";import"core-js/modules/es6.object.keys";import"core-js/modules/es6.regexp.match";import"core-js/modules/web.dom.iterable";import"core-js/modules/es6.regexp.split";import"core-js/modules/es6.number.constructor";import Vue from"vue";var BASE_REF_NAME="vue-pincode-input",LETTER_REGEXP="^\\d{1}$",script=Vue.extend({props:{value:{type:String,required:!0},length:{type:Number,default:4},autofocus:{type:Boolean,default:!0},secure:{type:Boolean,default:!1}},data:function data(){return{baseRefName:BASE_REF_NAME,letters:[],focusedLetterIdx:-1,watchers:{}}},computed:{pinCodeComputed:function pinCodeComputed(){return this.letters.reduce(function(a,b){return a+b.value},"")},inputType:function inputType(){return this.secure?"password":"tel"}},watch:{value:function value(){this.handleParentValue()},length:{handler:function handler(a){var b=this;this.unsetLettersWatchers(),this.letters=[];for(var c=function(a){b.letters.push({key:a,value:""});var c="letters.".concat(a,".value");b.watchers[c]=b.$watch(c,function(c,d){b.onLetterChanged(a,c,d)})},d=0;d<a;d+=1)c(d)},immediate:!0},focusedLetterIdx:function focusedLetterIdx(a){this.focusLetterByIndex(a)},pinCodeComputed:function pinCodeComputed(a){this.$emit("input",a)}},mounted:function mounted(){this.handleParentValue(),this.autofocus&&this.focusLetterByIndex(0)},methods:{handleParentValue:function handleParentValue(){var a=this;if(this.value&&this.value.length===this.length){var b=this.value.split("");b.forEach(function(b,c){a.letters[c].value=b||""})}},isTheLetterValid:function isTheLetterValid(a){return!(""!==a)||!!a&&!!a.match(LETTER_REGEXP)},onLetterChanged:function onLetterChanged(a,b){var c=this;0===b.length||(this.isTheLetterValid(b)?b.length&&this.setFocusedLetterIndex(this.focusedLetterIdx+1):this.$nextTick(function(){c.letters[a].value=c.isTheLetterValid(b[a])?b[a]:""}))},setFocusedLetterIndex:function setFocusedLetterIndex(a){0>a||a>=this.length||(this.focusedLetterIdx=a)},focusLetterByIndex:function focusLetterByIndex(a){var b="".concat(this.baseRefName).concat(a);this.$refs[b][0].focus(),this.$refs[b][0].select()},onDelete:function onDelete(a,b){this.letters[a].value||(this.setFocusedLetterIndex(this.focusedLetterIdx-1),b.preventDefault())},unsetLettersWatchers:function unsetLettersWatchers(){var a=this;Object.keys(this.watchers).forEach(function(b){a.watchers[b]()})}}});function normalizeComponent(a,b,c,d,e,f/* server only */,g,h,i,j){"boolean"!=typeof g&&(i=h,h=g,g=!1);// Vue.extend constructor export interop.
